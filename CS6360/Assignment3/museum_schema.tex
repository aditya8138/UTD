...
\begin{tikzpicture}
    ...
    \node [below=6em of artobject.west,
    ...
    \node [below=5em of painting.west,
            anchor=west] (sculpturestatue) {\textbf{SCULPTURE\_STATUE}};
    \node [relation=5,
            below=2em of sculpturestatue.west,
            anchor=west] (sculpturestatuesch) {
            \nodepart{one} \key{IDNo}
    ...
    \node [below=5em of sculpturestatue.west,
...
% FOREIGN KEYS
    ...
    \draw[relation_arrow] (paintingsch.one south) --
        ++(0,-0.4) -|
        ($(paintingsch.one south) + (-1,0)$) |-
        ($(artobjectsch.one south) + (0,-0.8)$) -|
        ($(artobjectsch.one south) + (0.3,0)$);
    \draw[relation_arrow] (sculpturestatuesch.one south) --
        ++(0,-0.4) -|
        ($(sculpturestatuesch.one south) + (-1.1,0)$) |-
        ($(artobjectsch.one south) + (0,-0.7)$) -|
        ($(artobjectsch.one south) + (0.2,0)$);
    \draw[relation_arrow] (othersch.one south) --
        ++(0,-0.4) -|
        ($(othersch.one south) + (-1.2,0)$) |-
        ($(artobjectsch.one south) + (0,-0.6)$) -|
        ($(artobjectsch.one south) + (0.1,0)$);
    \draw[relation_arrow] ($(permanentcollectionsch.one south) + (-0.1,0)$) --
        ++(0,-0.4) -|
        ($(permanentcollectionsch.one south) + (-1.3,0)$) |-
        ($(artobjectsch.one south) + (0,-0.5)$) -|
        ($(artobjectsch.one south) + (0,0)$);
    \draw[relation_arrow] (borrowedsch.one south) --
        ++(0,-0.4) -|
        ($(borrowedsch.one south) + (-1.4,0)$) |-
        ($(artobjectsch.one south) + (-0.1,-0.4)$) -|
        ($(artobjectsch.one south) + (-0.1,0)$);
